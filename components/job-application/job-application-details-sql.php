<?php
	...
	$userid = $_SESSION['userid_student'];
	$termid = $_SESSION['termid'];
	
	//check internship application if approved:
	$queryApp = "SELECT application_id FROM tbl_internship_application WHERE userid ='$userid' AND term_id = '$termid' AND tbl_internship_application.status_flag ='1'";
	...
	$query = "SELECT tbl_job_application.status_flag, tbl_job_application.date_applied, tbl_job_application.job_application_id, 
		...
		//AND tbl_internship_application.application_id = '$application_id'
		//AND tbl_job_application.userid = '$userid' AND tbl_job_application.term_id = '$termid'
