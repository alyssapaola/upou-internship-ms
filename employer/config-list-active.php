		...
		<header id="header">
			...
			<div class="container">
				<div class="logo float-left">
					...
					<h1 class="text-light"><a href="config-list-active.php" class="scrollto"><span>Web•IMS</span></a></h1>
						...
						<li class="drop-down active"><a href="#">Configuration</a>
							<ul>
								...
								<li class="drop-down active"><a href="config-listing.php">Manage Job Listing</a>
									<ul>
										<li class="active"><a href="config-list-active.php">Active Listing</a></li>
				...
				<div class="container">
					<div class="row">
						...
						<div class="about-content"  style="text-align:justify;">
							<h2>Job Listing</h2>
							<h4>Manages active job listings posted by the employer</h4>
						</div>
						
						<div class="table-responsive">
			
							<div align="left">  
								<form role="form" id="contact-form" method="post" enctype="multipart/form-data" action="config-listing-add.php" >
	...
	$(document).ready(function(){
		...
		function fetch_data(){
			var dataTable = $('#user_data').DataTable({
				...
				"order" : [],
				"ajax" : {
					url:"../components/config-listing/fetch-active.php",
					type:"POST"
				}
			});
		}
