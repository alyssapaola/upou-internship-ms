		...
		<header id="header">
			...
			<div class="container">
				<div class="logo float-left">
					...
					<h1 class="text-light"><a href="config-listing.php" class="scrollto"><span>Web•IMS</span></a></h1>
				...
				<div class="container">
					<div class="row">
						...
						<div class="about-content"  style="text-align:justify;">
							<h2>Job Listing</h2>
							<h4>Manages all job listings posted by the employer</h4>
						</div>
	...
	$(document).ready(function(){
		...
		function fetch_data(){
			var dataTable = $('#user_data').DataTable({
				...
				"order" : [],
				"ajax" : {
					url:"../components/config-listing/fetch.php",
					type:"POST"
				}
			});
		}
