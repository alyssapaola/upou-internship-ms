<?php
	...
	*/
	...
	if(!empty($_POST["register"])) {
		require_once "../components/employer/config-profile-sql.php";
	}
	...
	$query = "SELECT * FROM tbl_company 
				...
				WHERE tbl_company_employee.userid = '".$_SESSION["userid"]."'";  
		...
		<header id="header">
			...
			<div class="container">
				<div class="logo float-left">
					...
					<h1 class="text-light"><a href="config-profile.php" class="scrollto"><span>Web•IMS</span></a></h1>
				...
				<nav class="main-nav float-right d-none d-lg-block">
					<ul>
						...
						<li class="drop-down active"><a href="#">Configuration</a>
							<ul>
								<li class="active"><a href="config-profile.php">Manage Company Profile</a></li>
			...
			<section id="login">
				<div class="form">
					...
					<form method="post" action="" role="form" class="contactForm" enctype="multipart/form-data" onsubmit="return validateContactForm()">
						...
						<div class="form-group ">
							<label for="term_start"><b>Agreement Start Date </b></label>
							<input class="form-control" id="term_start" name="term_start" value="<?php echo $term_start_db; ?>" type="text" readonly />
							<div id="term_start-info" class="info"></div>
						</div>
						
						<div class="form-group ">
							<label for="term_end"><b>Agreement End Date </b></label>
							<input class="form-control" id="term_end" name="term_end" value="<?php echo $term_end_db; ?>" type="text" readonly />
