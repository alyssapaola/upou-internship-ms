<?php
	...
	*/
	...
	if(!isset($_GET["id"]) || !isset($_GET["stat"]) || $_GET["id"] == "" || $_GET["stat"] == ""  ){
		...
		//get 
		$query = "SELECT * FROM tbl_job WHERE job_id = '$job_id'";  
		...
		<header id="header">
			...
			<div class="container">
				...
				<nav class="main-nav float-right d-none d-lg-block">
					<ul>
						<li><a href="job-application.php">Back to Home</a></li>
					</ul>
				</nav><!-- .main-nav -->
			</div>
				...
				<div class="container">
					<div class="row">
						...
						<div class="about-content"  style="text-align:justify;">
							<h2><?php echo $status_name; ?> Application/s</h2>
	...
	$(document).ready(function(){
		...
		function fetch_data(){
			var dataTable = $('#user_data').DataTable({
				...
				"order" : [],
				"ajax" : {
					url:"../components/job-application/fetch-view.php",
					type:"POST"
				}
			});
		}
		...
		$(document).on('click', '.view', function(){  
			...
			if(id != ''){  
				$.ajax({  
                    url:"../components/job-application/details.php",  
                    method:"POST",  
                    data:{id:id, userid:userid, termid:termid },  
                    success: function(data){
					   window.location = "job-application-details.php";
					}
                });  
			}            
		});
