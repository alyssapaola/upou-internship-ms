		...
		<header id="header">
			...
			<div class="container">
				<div class="logo float-left">
					...
					<h1 class="text-light"><a href="job-application.php" class="scrollto"><span>Web•IMS</span></a></h1>
				...
				<nav class="main-nav float-right d-none d-lg-block">
					<ul>
						...
						<li class="active"><a href="job-application.php">Job Application</a></li>
	...
	$(document).ready(function(){
		...
		function fetch_data(){
			var dataTable = $('#user_data').DataTable({
				...
				"order" : [],
				"ajax" : {
					url:"../components/job-application/fetch.php",
					type:"POST"
				}
			});
		}
