		...
		<header id="header">
			...
			<div class="container">
				<div class="logo float-left">
					...
					<h1 class="text-light"><a href="config-section.php" class="scrollto"><span>Web•IMS</span></a></h1>
				...
				<nav class="main-nav float-right d-none d-lg-block">
					<ul>
						...
						<li class="active drop-down"><a href="#">Configuration</a>
							<ul>
								<li class="active"><a href="config-section.php">Manage Section</a></li>
				...
				<div class="container">
					<div class="row">
						...
						<div class="about-content"  style="text-align:justify;">
							<h2>Sections</h2>
							<h4>Modifies the details of each section</h4>
						</div>
				...
				<div class="modal-content">  
					<form method="post" id="insert_form">
						...
						<div class="modal-body">  
							<label><strong>Section Name </strong> <font color="red" style="font-weight: bold;">*</font> </label>  
							<input type="text" name="section_name" id="section_name" class="form-control" size="25" required />  
							<br />  
	...
	$(document).ready(function(){
		...
		function fetch_data(filter_role = ''){
			var dataTable = $('#user_data').DataTable({
				...
				"searching" : true,
				"ajax" : {
					url:"../components/config-section/fetch.php",
					type:"POST",
					data:{
		...
		$(document).on('click', '.edit', function(){  
			...
			$.ajax({  
                url:"../components/config-section/write.php",  
                method:"POST",  
		...
		$('#insert_form').on("submit", function(event){  
			...
			if($('#section_name').val() == ""){  
				...
				$.ajax({
					url : "../components/config-section/check.php",
					type : "POST",
					cache:false,
					data : {section_name:section_name, section_id:section_id},
					success:function(result){
						if (result == 1) {
							alert("Section alias is already taken!");  
						}
						else{
							$.ajax({  
								url:"../components/config-section/insert.php",  
								method:"POST",  
		...
		$(document).on('click', '.delete', function(){
			...
			if(confirm("Are you sure you want to remove this?")){
				$.ajax({
					url:"../components/config-section/delete.php",
					method:"POST",
					data:{id:id},
					success:function(data){
		...
		$(document).on('click', '.archive', function(){
			...
			if(confirm("Are you sure you want to archive this?")){
				$.ajax({
					url:"../components/config-section/archive.php",
					method:"POST",
					data:{id:id},
					success:function(data){
						$('#alert_message').html('<div class="alert alert-success">'+data+'</div>');
		...
		$(document).on('click', '.restore', function(){
			...
			if(confirm("Are you sure you want to restore this?")){
				$.ajax({
					url:"../components/config-section/restore.php",
					method:"POST",
					data:{id:id},
					success:function(data){
						$('#alert_message').html('<div class="alert alert-success">'+data+'</div>');
