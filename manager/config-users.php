<?php
	...
	$loc = $word."/config-users";
	$_SESSION['loc'] = $loc;
	
	$_SESSION['users'] = "staff";
		...
		<header id="header">
			...
			<div class="container">
				<div class="logo float-left">
					...
					<h1 class="text-light"><a href="config-users.php" class="scrollto"><span>Web•IMS</span></a></h1>
					...
					<ul>
						...
						<li class="active drop-down"><a href="#">Configuration</a>
							<ul>
								...
								<li class="active"><a href="config-users.php">Manage Users</a>
							</ul>
						</li>
				...
				<div class="container">
					<div class="row">
						...
						<div class="about-content"  style="text-align:justify;">
							<h2>Users</h2>
							<h4>Displays the units' list of users</h4>
						</div>
				...
				<div class="modal-content">  
					<form method="post" id="insert_form">
						...
						<div class="modal-body">  
							...
							<?php 
								$acctype_qry = "SELECT * FROM tbl_role WHERE role_name LIKE '%staff%'";
