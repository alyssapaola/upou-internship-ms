<?php
	...
	*/
	...
	$staff_value = '';
	$query = "SELECT * FROM tbl_user JOIN tbl_role ON tbl_role.role_id = tbl_user.role_id WHERE tbl_role.role_name LIKE '%staff%'";
	...
	foreach($result as $row){
		...
		$staff_value .= "<option value='".$row['userid']."'>".$name."</option>";
	}
		...
		<header id="header">
			...
			<div class="container">
				<div class="logo float-left">
					...
					<h1 class="text-light"><a href="intp-assignment.php" class="scrollto"><span>Web•IMS</span></a></h1>
				...
				<nav class="main-nav float-right d-none d-lg-block">
					<ul>
						...
						<li class="active drop-down"><a href="#">Internship Portal</a>
							<ul>
								<li class="active"><a href="intp-assignment.php">Faculty Assignment</a></li>
				...
				<div class="container">
					<div class="row">
						...
						<div class="about-content"  style="text-align:justify;">
							...
							<h4>Manages staff/faculty assignment of sections</h4>
						</div>
						...
						<div class="table-responsive">
							...
							<div class="row">
								...
								<div class="form-group" style="padding-top:-20px; " >
									...
									<button type="button" name="add" id="add" class="btn btn-danger" onclick="window.location.href='intp-assignment-add.php'" style="height:40px; width:60px;">Add</button>
								</div>
							</div>
	...
	$(document).ready(function(){
		...
		function fetch_data(filter_role = ''){
			var dataTable = $('#user_data').DataTable({
				...
				"searching" : true,
				"ajax" : {
					url:"../components/intp-assignment/fetch.php",
					type:"POST",
					data:{
		...
		$(document).on('click', '.delete', function(){
			...
			if(confirm("Are you sure you want to unassign this section?")){
				$.ajax({
					url:"../components/intp-assignment/delete.php",
					method:"POST",
					data:{id:id},
