		...
		<header id="header">
			...
			<div class="container">
				<div class="logo float-left">
					...
					<h1 class="text-light"><a href="jobp-department.php" class="scrollto"><span>Web•IMS</span></a></h1>
					...
					<ul>
						...
						<li class="active drop-down"><a href="#">Job Portal</a>
							<ul>	
								...
								<li class="active"><a href="jobp-department.php">Configure Department</a></li>
				...
				<div class="container">
					<div class="row">
						...
						<div class="about-content"  style="text-align:justify;">
							...
							<h4>Modifies general department of a company</h4>
						</div>
				...
				<div class="modal-content">  
					<form method="post" id="insert_form">
						...
						<div class="modal-body">  
							<label><strong>Department Name </strong> <font color="red" style="font-weight: bold;">*</font> </label>  
							<input type="text" name="dept_name" id="dept_name" class="form-control" size="25" required />  
							<br />  
	...
	$(document).ready(function(){
		...
		function fetch_data(){
			var dataTable = $('#user_data').DataTable({
				...
				"order" : [],
				"ajax" : {
					url:"../components/jobp-department/fetch.php",
					type:"POST"
				}
			});
		}
		...
		$(document).on('click', '.edit', function(){  
			...
			$.ajax({  
                url:"../components/jobp-department/write.php",  
                method:"POST",  
                data:{id:id},  
                dataType:"json",  
		...
		$('#insert_form').on("submit", function(event){  
			...
			if($('#dept_name').val() == ""){  
				...
				$.ajax({
					url : "../components/jobp-department/check.php",
					type : "POST",
					cache:false,
					...
					success:function(result){
						if (result == 1) {
							...
							$.ajax({  
								url:"../components/jobp-department/insert.php",  
								method:"POST",  
		...
		$(document).on('click', '.delete', function(){
			...
			if(confirm("Are you sure you want to remove this?")){
				$.ajax({
					url:"../components/jobp-department/delete.php",
					method:"POST",
					data:{id:id},
					success:function(data){
