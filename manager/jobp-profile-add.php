<?php
	...
	*/
	...
	if(!empty($_POST["register"])) {
		require_once "../components/jobp-profile/jobp-profile-add-sql.php";
	}
?>
				...
				<div class="form">
					...
					<form method="post" action="" role="form" class="contactForm" enctype="multipart/form-data" onsubmit="return validateContactForm()">
						...
						<div class="form-group">
							...
							<input type="text" class="form-control" name="company_name" id="company_name" value="<?php echo $_POST['company_name']; ?>" />
							<div id="company_name-info" class="info"></div>
						</div>
						
						<div class="form-group">
							<label for="company_desc"><b>Description <font color="red">*</font> </b></label>
							<textarea name="company_desc" id="company_desc" class="form-control" ><?php echo $_POST['company_desc']; ?></textarea>
						...
						<div class="form-group">
							<label for="address_other"><b>Floor/Unit/Room (optional) </b></label>
							<textarea name="address_other" id="address_other" class="form-control" ><?php echo $_POST['address_other']; ?></textarea>
							<div id="address_other-info" class="info"></div>
						</div>				
						
						<div class="form-group">
							<label for="company_email"><b>Email Address <font color="red">*</font> </b></label>
							<input type="email" class="form-control" name="company_email" id="company_email"  value="<?php echo $_POST['company_email']; ?>"  />
							<div id="company_email-info" class="info"></div>
						</div>
						
						<div class="form-group">
							<label for="company_mobile"><b>Mobile (optional) </b></label>
							<input type="text" class="form-control" name="company_mobile" id="company_mobile" value="<?php echo $_POST['company_mobile']; ?>"  />
							<div id="company_mobile-info" class="info"></div>
						</div>
						
						<div class="form-group">
							<label for="company_phone"><b>Phone (optional) </b></label>
							<input type="text" class="form-control" name="company_phone" id="company_phone" value="<?php echo $_POST['company_phone']; ?>" />
							<div id="company_phone-info" class="info"></div>
						</div>
						
						<div class="form-group ">
							<label for="term_start"><b>Agreement Start Date <font color="red">*</font> </b></label>
							<input class="form-control" id="term_start" name="term_start" placeholder="January 01, 1970" type="text"/>
							<div id="term_start-info" class="info"></div>
						</div>
						
						<div class="form-group ">
							<label for="term_end"><b>Agreement End Date <font color="red">*</font> </b></label>
							<input class="form-control" id="term_end" name="term_end" placeholder="January 01, 1970" type="text"/>
						...
						<div class="form-group">
							<label for="company_img"><b>Image/Logo <font color="red">*</font> </b></label>
...
<script type="text/javascript">
	...
	function validateContactForm() {
		...
		var company_img = $("#company_img-input").val();
		...
		if (company_img == "") {
			$("#company_img-info").html("Please choose an image");
			$("#company_img").css('border', '#ff0000 1px solid');
			valid = false;
		}
