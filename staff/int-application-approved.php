						...
						<li class="active drop-down"><a href="#">Internship Module</a>
							<ul>
								...
								<li class="active drop-down"><a href="int-application.php">Application</a>
									<ul>
										<li class="active"><a href="int-application-approved.php">Approved Application</a></li>
				...
				<div class="container">
					<div class="row">
						...
						<div class="about-content"  style="text-align:justify;">
							<h2>Approved Internship Applications</h2>
							<h4>Displays all approved application of the students</h4>
						</div>
				...
				<div class="modal-content">  
					<form method="post" id="insert_form">
						...
						<div class="modal-header">  
							...
							<h4 class="modal-title">Section Assignment</h4>  
						</div>  
						
						<div class="modal-body">  
				
							<label><strong>Student Number: </strong> </label>  
							<input type="text" class="form-control" name="student_number" id="student_number" disabled />
							<br />  
							...
							<input type="text" class="form-control" name="college_fullname" id="college_fullname" disabled />
							<br />  
							
							<label><strong>Course: </strong> </label>  
							<input type="text" class="form-control" name="course_fullname" id="course_fullname" disabled />
							<br />  
							
							<label><strong>Section: </strong> <font color="red" style="font-weight: bold;">*</font> </label>
								...
								<?php
									...
									if(mysqli_num_rows($course_rslt) > 0){
										while($course_row = mysqli_fetch_assoc($course_rslt)){
											...
											$sec_qry = "SELECT * FROM  tbl_section 
														JOIN tbl_section_assignment ON tbl_section_assignment.section_id = tbl_section.section_id
														WHERE tbl_section.course_id = '$course' AND tbl_section_assignment.user_id = '$staff_userid'
														ORDER BY tbl_section.section_name ASC";
						...
						<div class="modal-footer">  
							<input type="submit" name="insert" id="insert" value="Assign Now" class="btn btn-danger" />  
	...
	$(document).ready(function(){
		...
		function fetch_data(filter_role = '', filter_role_1 = ''){
			var dataTable = $('#user_data').DataTable({
				...
				"searching" : true,
				"ajax" : {
					url:"../components/int-application/fetch-approved.php",
					type:"POST",
					data:{
		...
		$(document).on('click', '.edit', function(){  
			...
			$.ajax({  
                url:"../components/int-application/forsection-write.php",  
                method:"POST",  
                data:{id:id},  
                dataType:"json",  
                success:function(data){  
                    ...
                    $('#college_fullname').val(data.college_fullname);  
					$('#course_fullname').val(data.course_fullname);  
		...
		$('#insert_form').on("submit", function(event){  
			...
			if($('#section').val() == ""){  
				...
				$.ajax({  
					url:"../components/int-application/forsection-insert.php",  
					method:"POST",  
					data:$('#insert_form').serialize(),  
					beforeSend:function(){  
					  $('#insert').val("Assigning");  
					},  
					success:function(data){
						$('#insert_form')[0].reset();  
