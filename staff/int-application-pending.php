							...
							<ul>
								...
								<li class="active drop-down"><a href="int-application.php">Application</a>
									<ul>
										...
										<li class="active"><a href="int-application-pending.php">Pending Application</a></li>
				...
				<div class="container">
					<div class="row">
						...
						<div class="about-content"  style="text-align:justify;">
							...
							<h4>Displays all pending application of the students</h4>
						</div>
	...
	$(document).ready(function(){
		...
		function fetch_data(filter_role = '', filter_role_1 = ''){
			var dataTable = $('#user_data').DataTable({
				...
				"searching" : true,
				"ajax" : {
					url:"../components/int-application/fetch-pending.php",
					type:"POST",
					data:{
