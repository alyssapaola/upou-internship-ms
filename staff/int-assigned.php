<?php
	...
	*/
	...
	$query = "SELECT * FROM  tbl_section 
			...
			WHERE tbl_section_assignment.user_id = '$staff_userid'
	...
	foreach($result as $row){
		...
		$section .= '<option value="'.$section_id.'">'.$section_name.'</option>';
	}
		...
		<header id="header">
			...
			<div class="container">
				<div class="logo float-left">
					...
					<h1 class="text-light"><a href="int-assigned.php" class="scrollto"><span>Web•IMS</span></a></h1>
					...
					<ul>
						...
						<li class="active drop-down"><a href="#">Internship Module</a>
							<ul>
								...
								<li class="active"><a href="int-assigned.php">Section Assigned</a></li>
							</ul>
						</li>
				...
				<div class="container">
					<div class="row">
						...
						<div class="about-content"  style="text-align:justify;">
							...
							<h4>Displays all students assigned to the faculty/staff</h4>
						</div>
	...
	$(document).ready(function(){
		...
		function fetch_data(filter_role = '', filter_role_1 = ''){
			var dataTable = $('#user_data').DataTable({
				...
				"searching" : true,
				"ajax" : {
					url:"../components/int-assigned/fetch.php",
					type:"POST",
					data:{
