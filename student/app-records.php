<?php
	...
	*/
	...
	$_SESSION['app-records'] = "1";
	
	//get data
	$query = "SELECT tbl_internship_application.status_flag, tbl_internship_application.application_id, 
			...
			WHERE tbl_internship_application.userid ='$userid'";
		...
		<header id="header">
			...
			<div class="container">
				<div class="logo float-left">
					...
					<h1 class="text-light"><a href="app-records.php" class="scrollto"><span>Web•IMS</span></a></h1>
				...
				<nav class="main-nav float-right d-none d-lg-block">
					<ul>
						...
						<li class="active drop-down"><a href="application.php">Application</a>
							<ul>
								<li class="active"><a href="app-records.php">Records</a></li>
							</ul>
						</li>
					...
					<div class="row">
						...
						<div class="about-content"  style="text-align:justify;">
							...
							?>
									...
									<h4>View/Download your Internship Application/s</h4>
						...
						?>
								...
								<form role="form" id="contact-form" method="post" action="app-success-view.php" enctype="multipart/form-data" >
										...
										<table id="user_data" class="table table-bordered table-striped">
											...
											?>
													<tbody >
														...
														<td class="<?php echo $class; ?>"><?php echo $application_id; ?></td>
														<td class="<?php echo $class; ?>"><?php echo strtoupper($status_name); ?></td>
														<td>
															<button type="submit" name="application_id" value="<?php echo $application_id; ?>" class="view btn btn-danger btn-xs active_flg">View Application</button>
														</td>
													</tbody>
											<?php
