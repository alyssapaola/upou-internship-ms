<?php
	...
	*/
	...
	if(isset($_POST['job_application_id'])){
		include '../components/student/vac-applications-view-sql.php';
	}
	else{
		...
		<header id="header">
			...
			<div class="container">
				...
				<nav class="main-nav float-right d-none d-lg-block">
					<?php
						if ($_SESSION['vac-history'] == "1"){
					?>
							
							<li><a href="vac-history.php">Back to Home</a></li>
					...
					?>
							...
							<li><a href="vac-applications.php">Back to Home</a></li>
