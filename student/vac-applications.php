<?php
	...
	*/
	...
	//get data
	$query = "SELECT tbl_job_application.job_application_id, tbl_job_application.status_flag, tbl_job.job_name, tbl_company.company_name, tbl_status.status_name
			...
			WHERE tbl_job_application.userid = '$userid' AND tbl_job_application.term_id = '$term_id'";
		...
		<header id="header">
			...
			<div class="container">
				<div class="logo float-left">
					...
					<h1 class="text-light"><a href="vac-applications.php" class="scrollto"><span>Web•IMS</span></a></h1>
				...
				<nav class="main-nav float-right d-none d-lg-block">
					<ul>
						...
						<li class="active drop-down"><a href="vacancies.php">Job Vacancies</a>
							<ul>
								<li class="active"><a href="vac-applications.php">Applications</a></li>
					...
					<div class="row">
						...
						<div class="about-content"  style="text-align:justify;">
							...
							?>
									...
									<h4>View your current job application/s</h4>
