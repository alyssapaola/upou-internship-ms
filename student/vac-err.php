		...
		<main id="main">
			...
			<section id="about" >
				...
				<div class="container"  style="text-align:justify; padding-top:20px;">
					...
					<?php 
						if ($_SESSION['vac_err'] == "1"){
					?>
							<h5>Job application has been approved. Nothing to view here. </h5>
					<?php
						}
					?>
					
					<?php 
						if ($_SESSION['vac_err'] == "2"){
					?>
							<h5>No job listing posted yet. Contact CCSIR for inquiries. </h5>
					<?php
						}
					?>
					
					<?php 
						if ($_SESSION['vac_err'] == "3"){
					?>
							<h5>Internship application must be approved first. </h5>
					<?php
						}
					?>
